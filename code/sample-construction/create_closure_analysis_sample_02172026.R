...
# Call report data
call_reports <- readRDS(file.path(data_dir, "call_data_02172026.rds"))
...
call_reports[,core_deposits_assets:=core_deposits/bank_assets]
call_reports[,time_deposits_assets:=(time_deposits_below_ins_limit+time_deposits_above_ins_limit)/bank_assets]
call_reports[,brokered_deposits_assets:=brokered_deposits/bank_assets]

# Winsorize ratio variables at 1 (max)
call_reports[, ci_assets := pmin(ci_assets, 1)]
call_reports[, uninsured_deposits_frac := pmin(uninsured_deposits_frac, 1)]
call_reports[, core_deposits_assets := pmin(core_deposits_assets, 1)]
call_reports[, time_deposits_assets := pmin(time_deposits_assets, 1)]
call_reports[, brokered_deposits_assets := pmin(brokered_deposits_assets, 1)]
...
call_reports[, brokered_deposits_assets := nafill(brokered_deposits_assets, type = "nocb"), by = ID_RSSD]
call_reports[, core_deposits_assets := nafill(core_deposits_assets, type = "nocb"), by = ID_RSSD]
call_reports[, time_deposits_assets := nafill(time_deposits_assets, type = "nocb"), by = ID_RSSD]
call_reports[, trans_accts_frac_assets := nafill(trans_accts_frac_assets, type = "nocb"), by = ID_RSSD]
call_reports[, ci_assets := nafill(ci_assets, type = "nocb"), by = ID_RSSD]
