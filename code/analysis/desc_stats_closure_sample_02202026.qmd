...
# Uncomment to save
ggsave(file.path("../../docs/figures/beta_density_bank.jpg"), g,
       width = 5, height = 3)
```
...
# Uncomment to save
ggsave(file.path( "../../docs/figures/beta_density_branch.jpg"), g,
       width = 5, height = 3)
```
...
# Uncomment to save
ggsave(file.path( "../../docs/figures/df_scatter_branch_mid_late.jpg"), g,
       width = 4, height = 3.5)
```
...
# Uncomment to save
ggsave(file.path( "../../docs/figures/df_scatter_branch_early_mid.jpg"), g,
       width = 4, height = 3.5)
```
...
# Uncomment to save
ggsave(file.path( "../../docs/figures/df_scatter_bank_early_mid.jpg"), g1,
       width = 4, height = 3.5)
```
...
# Uncomment to save
ggsave(file.path("../../docs/figures/df_scatter_bank_mid_late.jpg"), g2,
       width = 4, height = 3.5)
```
...
# Uncomment to save
ggsave(file.path("../../docs/figures/univar_branch_closure.jpg"), g,
       width = 5, height = 3.5)
```
